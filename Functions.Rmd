...
There are exceptions to every rule, and in this case, there is a small selection of "primitive" base functions that are implemented purely in C. As a result, they can not be broken down into components.
